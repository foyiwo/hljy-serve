...
public class MallWxController {
    ...
    @ResponseBody
    public String authCallback(@RequestParam(value = "code") String code,@RequestParam(value = "state") String state) throws IOException {
        ...
        //重定向
        response.sendRedirect("http://hljy.foyiwo.com/user.html");
        return null;
    }
